...
namespace PCAB_Debugger_GUI
{
    ...
    public class agPNA835x
    {
        ...
        public bool GetScreen(string filePATH, out string ErrorMessage)
        {
            ...
            byte[] byIMG = instr.IEEE488_VisaControl.ReadBinaryIEEEblock();
        ...
        {
            instr.IEEE488_VisaControl.WriteAsciiCmdLine(cmd);
        }

        public string getASCII() { return instr.IEEE488_VisaControl.ReadAsciiBlock().Trim('\n').Trim('\"'); }
