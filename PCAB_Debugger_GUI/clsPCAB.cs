    ...
    public class PCAB
    {
        ...
        public bool PCAB_AutoTaskStart(UInt32 waiteTime, string[] serialNum)
        {
            ...
            try
            {
                ...
                foreach (string s in serialNum)
                {
                    ...
                    if (arrBf[0] == "Orient Microwave Corp." && arrBf[1] == "LX00-0004-00" && arrBf[3].Substring(0,5) == "1.1.2" && (arrBf[2] == s || "*" == s))
                    {
        ...
        public bool PCAB_PRESET(string serialNum)
        {
            ...
            try
            {
                ...
                if (arrBf[0] == "Orient Microwave Corp." && arrBf[1] == "LX00-0004-00" && arrBf[2] == serialNum && arrBf[3] == "1.1.2")
                { return true; }
                else { return false; }
            }
            catch (Exception e)
